...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`posdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
(8,'2019_11_01_140853_create_products_table',3),
(18,'2019_11_11_074157_create_tranactions_table',7),
(20,'2019_11_11_076105_create_sales_table',8);
...
CREATE TABLE `transactions` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tranactions_actor_id_foreign` (`actor_id`),
  CONSTRAINT `tranactions_actor_id_foreign` FOREIGN KEY (`actor_id`) REFERENCES `actors` (`id`)
